...
@Component({
  ...
  template: `
    <div class="orders">
      ...
      <section class="panel">
        ...
        } @else { <p class="muted">Заказов по вашим событиям пока нет или вы не авторизованы в Telegram.</p> }
      </section>
  ...
  styles: [`
    ...
    @media (max-width: 650px) { .row { grid-template-columns: 1fr auto; } .row > :nth-child(2) { grid-column: 1; } .row > :nth-child(3), .row > :nth-child(4) { grid-row: 1; } }
  `],
})
